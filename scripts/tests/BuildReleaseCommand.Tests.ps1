Describe 'Verified release build command' {
    It 'builds and promotes only the approved version 2.0.3 APK' {
        ...
        $releaseApk = Join-Path $outputDirectory 'tracking-gps-2.0.3.apk'
        ...
        ($output -join "`n") | Should Match '2.0.3 \(5\)'
