Describe 'Verified release build command' {
    It 'builds and promotes only the approved version 2.1.0 APK' {
        ...
        $releaseApk = Join-Path $outputDirectory 'tracking-gps-2.1.0.apk'
        ...
        ($output -join "`n") | Should Match '2.1.0 \(6\)'
